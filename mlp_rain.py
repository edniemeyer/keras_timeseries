...
def evaluate_model(model, name, n_layers, ep, normalization, TRAIN_SIZE, dataset, ewm_dolar, type):
    ...
    csv_logger = CSVLogger('output/%d_layers/rain_%s_%s.csv' % (n_layers, name, normalization))
    ...
    for o in range(2,30, 30):
        for p in seed:
            ...
            for normalization in normalizations:
                ...
                model.add(Dense(9, input_shape=(TRAIN_SIZE,), kernel_initializer='glorot_uniform',
                ...
                trainScore, testScore, epochs, optimizer = evaluate_model(model, name, n_layers, nb_epoch,
                                                                          norm, TRAIN_SIZE, dataset, ewm_dolar, type=type)
